...
export default function UserDashboard() {
  ...
  // Get lowercase tier for comparisons
  const userTier = user?.tier || 'lite';

  // Fetch credit history if user has deep tier or higher
  const hasAccessToHistory = ['deep', 'ultimate', 'enterprise'].includes(userTier);
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center">
                <span className="font-medium text-lg mr-2">
                  {user?.creditsBalance?.currentBalance || 0}
                </span>
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {/* Lite Plan */}
            <div className={`border ${userTier === 'lite' ? 'border-primary-200 bg-primary-50' : 'border-gray-200'} rounded-lg p-4 hover:shadow-md transition-shadow duration-200`}>
            ...
            {/* Deep Plan */}
            <div className={`border ${userTier === 'deep' ? 'border-primary-200 bg-primary-50' : 'border-gray-200'} rounded-lg p-4 hover:shadow-md transition-shadow duration-200`}>
              <div className="flex justify-between items-start">
                <div>
            ...
            {/* Ultimate Plan */}
            <div className={`border ${userTier === 'ultimate' ? 'border-primary-200 bg-primary-50' : 'border-gray-200'} rounded-lg p-4 hover:shadow-md transition-shadow duration-200`}>
              <div className="flex justify-between items-start">
                <div>
              ...
              {userTier !== 'ultimate' ? (
                ...
                <Button variant="default" className="mt-4 w-full cursor-default">Current Plan</Button>
              )}
            </div>

            {/* Enterprise Plan */}
            <div className={`border ${userTier === 'enterprise' ? 'border-primary-200 bg-primary-50' : 'border-gray-200'} rounded-lg p-4 hover:shadow-md transition-shadow duration-200`}>
              <div className="flex justify-between items-start">
                <div>
